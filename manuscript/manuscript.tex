...
\section{Source layouts}

Describe the proposed source layouts.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Comparison of source layouts}

Describe forward model made out of prisms, ground and airborne survey (plus noise), the
target grid, how do we score each interpolation.
