...
failing to produce accurate predictions.
...
dataset.
The choice of the damping and any other hyper-parameter could be done through
validation methods, such as cross-validation algorithms.
