...
\begin{figure*}
    ...
    \caption{
        ...
        (c) Root-mean square error of the residue after each iteration of the
...
residue after each iteration of the gradient-boosting algorithm, exposing how
to algorithm converges at a minimum difference between the gravity disturbance
