...
\begin{enumerate}
  ...
  \item Create $K$ separate sets of equivalent sources, one for each window.
    ...
    be greater than $M$.
  \item Define vector $\mathbf{c}_k$ as the coefficients of the equivalent
    sources of the $k$-th window.
  \item Define matrix $\mathbf{A}_k$ as the Jacobian matrix between the sources
    in the $k$-th window and all $N$ data points of the survey.
