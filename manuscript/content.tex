...
Figure \ref{fig:eql-boost-airborne}a shows the difference between the target
...
\begin{figure}
    ...
    \caption{
        ...
        a)~Pseudo-color maps of the differences between the target grid and the
        interpolated synthetic airborne survey data produced gradient-boosted
        equivalent sources.
        b)~Root-mean squared error of the residuals after each iteration of the
