...
\begin{figure*}
    ...
    \caption{
        ...
        (b) K-Fold cross-validation root-mean square errors obtained after the
        for each pair of damping and depth parameters. The orange
        square highlights the minimum.
        (c) Root-mean square error against the observed data after each
...
Figure \ref{fig:australia-memory-cv-error}b shows the resulting
...
Fig.~\ref{fig:australia-memory-cv-error}c shows the RMS error against the
...
The largest residuals are located in regions with high-amplitude
short-wavelength features in the observed data.
