...
# # Create synthetic ground and airborne surveys from a synthetic model made out of prisms
...
easting, northing = projection(
    region_degrees[:2], region_degrees[2:]
)
...
# We want to compute the true gravitational effect generated by the synthetic model on a regular grid at a constant height.
